...
pl.depdownload_msg=Nastêpuj¹ce komponenty s¹ konieczne do pobrania z sieci:%n%n%1%nCzy pobraæ i zainstalowaæ?
...
pl.depdownload_admin=Do zainstalowania tych komponentów wymagane jest konto administatora.%nProszê uruchomiæ program instalacyjny ponownie u¿ywaj¹c 'Uruchom jako Administrator' lub zainstalowaæ komponenty samodzielnie:%n%n%1%nZamknij to okno i wciœnij 'Anuluj' w celu przerwania instalacji.
