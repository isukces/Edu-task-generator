...
begin
  ...
  Log('Checking .NET Desktop Runtime 8.0.11');
  if not Dependency_IsNetCoreInstalled('Microsoft.WindowsDesktop.App 8.0.11') then begin
    Log('Adding .NET Desktop Runtime 8.0.11');
...
[Code]
function InitializeSetupXXXXX: Boolean;
begin
#ifdef UseDotNet35
